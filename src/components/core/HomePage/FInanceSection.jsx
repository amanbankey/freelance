          ...
          >
            ...
            <div className="relative" style={{ width: 260, height: 270 }}>
              ...
              <div
                ...
                className="w-48 h-52 rounded-3xl p-4 bg-[#2ed283] shadow-2xl"
              >
              ...
              <div
                ...
                className="w-48 h-44 rounded-3xl  bg-white border-[3px] border-[#5aacff] shadow-2xl"
              >
              ...
              <div
                ...
                className="w-48 h-52 rounded-3xl p-4 bg-[#ffe6f4] shadow-2xl text-center"
              >
              ...
              <div
                ...
                className="w-48 h-52 rounded-3xl shadow-2xl overflow-hidden bg-gradient-to-br from-amber-400 to-orange-500 flex flex-col items-center justify-center"
              >
              ...
              <div
                ...
                className="w-52 h-52 rounded-3xl shadow-2xl overflow-hidden bg-gradient-to-br from-amber-400 to-orange-500 flex flex-col items-center justify-center"
              >
              ...
              <div
                ...
                className="w-52 h-52 rounded-3xl shadow-2xl overflow-hidden bg-gradient-to-br from-amber-400 to-orange-500 flex flex-col items-center justify-center"
              >
                 <img src={single} className="h-44 w-44 rounded-3xl"/>
              </div>
