...
const SLIDES = [
  {
    ...
    heading: (
      <>
        World Class <span className="text-[#F9981C]"> Engineering </span>{" "}
        Services Provider
      </>
    ),
  ...
  },
  {
    ...
    heading: (
      <>
        Trusted <span className="text-[#F9981C]"> Structural </span> Design
        Solutions
      </>
    ),
          ...
          >
            <div className='max-w-7xl w-full px-4 sm:px-6 md:px-8 lg:px-10'>
              <div className="w-full flex justify-end">
                ...
                <div className='w-full sm:w-auto'>
                  {/* Heading */}
                  <div className="mb-3 sm:mb-4 md:mb-6 text-white font-semibold
